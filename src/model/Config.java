...
public class Config {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/db_healink";
    ...
    public static void writeLog(String message) {
        ...
        try (FileWriter fwLog = new FileWriter("log.txt", true); PrintWriter pwLog = new PrintWriter(fwLog);) {
